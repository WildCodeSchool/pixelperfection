 ...
 */
final class Version20240118173513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quality (id INT AUTO_INCREMENT NOT NULL, perfume INT NOT NULL, texture INT NOT NULL, application INT NOT NULL, packaging_attractive INT NOT NULL, packaging_convenient INT NOT NULL, efficiency INT NOT NULL, allergy TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
